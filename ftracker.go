...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	if action < 0 {
		fmt.Println("Количество шагов не может быть отрицательным")
		return 0
	}
	...
	if duration < 0 {
		fmt.Println("Длительность тренировки не может быть отрицательной")
		return 0
	}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	if lengthPool < 0 {
		fmt.Println("Длина бассейна не может быть отрицательной")
		return 0
	}

	if countPool < 0 {
		fmt.Println("Количество переплывов бассейна не может быть отрицательным")
		return 0
	}
